...
namespace TLab.Editor
{
    public static class LUTEditorUtil
    {
        ...
        public static void DrawGrid(Rect area, float div, int xAccuracy, int yAccuracy, float lutXMin, float lutXMax, float lutYMin, float lutYMax)
        {
            /**
             * grid color
             */
            ...
            for (int xi = 1; xi < div - 1; ++xi)
            {
                ...
                var value = lutXMin * (1f - lerp) + lutXMax * lerp;
            ...
            for (int yi = 1; yi < div - 1; ++yi)
            {
                ...
                var value = lutYMin * (1f - lerp) + lutYMax * lerp;
